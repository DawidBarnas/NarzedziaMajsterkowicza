                ...
                public void onDecoded(@NonNull @NotNull Result result) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ScannerAC.this, result.getText(), Toast.LENGTH_LONG).show();
    ...
    private void askPermission(){
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP){
            ...
            if (ActivityCompat.checkSelfPermission(this,Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ){
                ...
                ActivityCompat.requestPermissions(ScannerAC.this,new String[]{Manifest.permission.CAMERA},CAMERA_PERM);
